 ...
 * Main header
 */
if ( ! function_exists( 'ict_camp_header' ) ) :
    function ict_camp_header() {
        global $event_star_customizer_all_values;
                        ...
                        <div class="col-sm-6 text-right">
                            <?php
                                ...
                                <div class="at-first-level-nav at-display-inline-block text-right">
                                    <?php ictcamp_localize_manager()->echo_language_selectors(); ?>
                                </div>
...
add_action( 'ict_camp_action_header', 'ict_camp_header', 10 );